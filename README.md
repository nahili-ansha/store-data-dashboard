# Web Development Project 6 - *Store Data Dashboard*

Submitted by: **Nahili Ansha**

This web app: **A single-page React dashboard that fetches product data from the Fake Store API (https://fakestoreapi.com) and presents a searchable, filterable product list plus detailed product pages and data visualizations**
...
* [x ] Search and category filtering for the product list (live filter).
* [x ] Responsive layout with a shared sidebar and main content area.
* [ x] Graceful loading and error handling when fetching data from the API.
